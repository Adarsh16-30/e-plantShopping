  ...
  return (
    <div>
      <div className="navbar">
        <div className="tag_home_link" style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          <img src="https://cdn-icons-png.flaticon.com/512/2909/2909765.png" alt="logo" style={{ width: 50, height: 50, borderRadius: '50%' }} />
          <div>
            <div style={{ fontWeight: 'bold', fontSize: 28 }}>Paradise Nursery</div>
            <div style={{ fontSize: 15 }}>Where Green Meets Serenity</div>
          </div>
        </div>
        <div style={{ flex: 1, textAlign: 'center', fontSize: 28, fontWeight: 500, color: '#fff' }}>
          Plants
          <button
            style={{
              marginLeft: 40,
        ...
        <div className="cart" style={{ position: 'relative', marginRight: 30, cursor: 'pointer' }} onClick={() => setShowCart(true)}>
              ...
              <div className="product-list">
                {category.plants.map((plant, plantIndex) => (
                  <div className="product-card" key={plantIndex}>
                    ...
                    <div className="product-price" style={{ color: '#e74c3c', fontWeight: 'bold', fontSize: '18px', margin: '10px 0' }}>{plant.cost}</div>
                    <div style={{ fontStyle: 'italic', marginBottom: 10 }}>{plant.description}</div>
                    <button
